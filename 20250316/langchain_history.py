...
# 첫 번째 메시지
response = process_conversation("안녕? 넌 누구야?", session_id)
print(f"첫 번째 응답: {response}")

# 두 번째 메시지
response = process_conversation("내가 뭐라고 했었지?", session_id)
print(f"\n두 번째 응답: {response}")

# 세 번째 메시지
response = process_conversation("내가 전에 했던 질문을 기억하고 있니?", session_id)
print(f"\n세 번째 응답: {response}")
